...
$username = "id15297269_mariushenderson18";
$password = "Internet_123";
$dbname = "id15297269_signupform44";
...
<form name="form1" method="post" action="signupuser.php" onSubmit="return check();" >
   ...
   <input type="text" id="name" name="userid"><br><br>
   <label for=""pwd">Password</label>
   <input type="password" id="login" name="password"><br><br>
     
   <label for=""pwd"> Confirm   </label>
   <input type="password" id="pass" name="confirm"><br><br>
